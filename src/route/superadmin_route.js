...
superAdminRouter.get('/superadmin/shop/admin/:shopId', authMiddleware, superAdminController.getShopAdmin)
superAdminRouter.get('/superadmin/shop/staff-kasir/:shopId', authMiddleware, superAdminController.getStaffKasir)
superAdminRouter.get('/superadmin/shop/staff-gudang/:shopId', authMiddleware, superAdminController.getStaffGudang)
superAdminRouter.get('/superadmin/shop/products/:shopId', authMiddleware, superAdminController.getShopProducts)
