...
superAdminRouter.post('/superadmin/registrasi/admin', authMiddleware, superAdminController.registerAdmin)
superAdminRouter.get('/superadmin/all-shop', authMiddleware, superAdminController.getAllShop)
