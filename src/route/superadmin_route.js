...
superAdminRouter.get('/superadmin/dashboard/saff/:shopId', authMiddleware, superAdminController.getShopStaffs)
superAdminRouter.get('/superadmin/dashboard/staff/:shopId', authMiddleware, superAdminController.getShopProducts)
